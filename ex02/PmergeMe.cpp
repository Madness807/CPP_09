...
double PmergeMe::sortAndMeasureTime(Container& container) {
    ...
    sortContainer(container, 0, container.size() - 1);
...
void PmergeMe::sortContainer(std::vector<int>& container, int left, int right) {
    mergeSortVector(container, left, right);
}

void PmergeMe::sortContainer(std::deque<int>& container, int left, int right) {
    mergeSortDeque(container, left, right);
}
